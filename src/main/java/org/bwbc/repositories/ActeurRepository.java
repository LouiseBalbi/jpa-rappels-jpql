...
public interface ActeurRepository extends CrudRepository<Acteur, Long> {
	 ...
	 * @return List
	 */
	@Query("From Acteur a where year(a.anniversaire)= :annee ORDER BY a.anniversaire ASC")
	 ...
	 * @return List
	 */
	@Query("select distinct a From Acteur a JOIN a.roles r JOIN r.film f JOIN f.realisateurs re where re.identite = :identite  and f.annee between :anneeMin and :anneeMax")
